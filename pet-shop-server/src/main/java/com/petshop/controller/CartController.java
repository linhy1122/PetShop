...
public class CartController {
    ...
    /** 加入购物车 */
    @PostMapping("/add")
    public Result<Object> add(@RequestParam Long userId,
    ...
    public Result<Object> updateQuantity(@PathVariable Long cartId,
    ...
    public Result<Object> updateCheck(@PathVariable Long cartId,
    ...
    public Result<Object> remove(@PathVariable Long cartId) {
    ...
    /** 批量删除购物车项 */
    @DeleteMapping("/batch")
    public Result<Object> batchRemove(@RequestParam List<Long> ids) {
    ...
    public Result<Object> clearOffline(@RequestParam Long userId) {
    ...
    public Result<Object> checkAll(@RequestParam Long userId,
                              @RequestParam Integer checked) {
